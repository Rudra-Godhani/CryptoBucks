                            ...
                            <div className='flex flex-col md:w-[45%] w-full h-full pr-2'>
                                ...
                                <div className='flex sm:flex-row flex-col w-full mt-4 justify-between'>
                                    ...
                                    <div className='flex flex-col sm:mt-0 mt-1'>
                                        ...
                                        <h2 className='text-base font-bold'>{new Intl.NumberFormat("en-IN", {
                                            ...
                                            currency: currency,
                                            notation: "compact"
                                        }).format(data.market_data.fully_diluted_valuation[currency])}</h2>
                                    </div>
                                </div>
                                ...
                                <div className='flex w-full mt-4 justify-between'>
                                    ...
                                    <h2 className='text-basee font-bold'>{new Intl.NumberFormat("en-IN", {
                                        ...
                                        currency: currency,
                                        minimumFractionDigits: 0,
                                    }).format(data.market_data.total_volume[currency])}</h2>
                                </div>
                                ...
                                <div className='flex w-full mt-4 justify-between'>
                                    <div className='flex flex-col'>
                                        ...
                                        }).format(data.market_data.low_24h[currency])}</h2>
                                    </div>
                                    <div className='flex flex-col'>
                                        <span className='text-sm capitalize text-gray-100'>High 34H</span>
                                        <h2 className='text-base font-bold'>{new Intl.NumberFormat("en-IN", {
                                            style: "currency",
                                            currency: currency,
                                            minimumFractionDigits: 5,
                                        }).format(data.market_data.high_24h[currency])}</h2>
                                    </div>
                                </div>
                                ...
                                <div className='flex w-full mt-4 justify-between'>
                                    <div className='flex flex-col'>
                                        ...
                                        <h2 className='text-basee font-bold'>{new Intl.NumberFormat("en-IN", {
                                            ...
                                            currency: currency,
                                            minimumFractionDigits: 0,
                                        }).format(data.market_data.max_supply)}</h2>
                                    </div>
                                    <div className='flex flex-col'>
                                        ...
                                        <h2 className='text-base font-bold'>{new Intl.NumberFormat("en-IN", {
                                            ...
                                            currency: currency,
                                            minimumFractionDigits: 0,
                                        }).format(data.market_data.circulating_supply)}</h2>
                                    </div>
                                </div>
                                ...
                                <div className='flex w-full mt-4 justify-between sm:flex-row flex-col'>
                                    <div className='flex flex-col'>
                                        ...
                                        <a target={"_black"} rel="noreffrrer" className='text-sm bg-gray-200 text-gray-100 px-1.5 py-0.5 my-1 rounded' href={data?.links?.blockchain_site[0]}>{data?.links?.blockchain_site[0].substring(0, 30)}</a>
                                        {
                                            ...
                                            <a target={"_black"} rel="noreffrrer" className='text-sm bg-gray-200 text-gray-100 px-1.5 py-0.5 my-1 rounded' href={data?.links?.official_forum_url[0]}>{data?.links?.official_forum_url[0].substring(0, 30)}</a>
                                        }
                                    </div>
                                    <div className='flex flex-col content-start'>
                                        <span className='text-sm capitalize text-gray-100'>sentiment</span>
                                        <div className='flex justify-between'>
                                            <div className={`text-sm px-1 ml-2 my-1 font-medium flex items-center rounded uppercase bg-opacity-25 bg-green text-green`}><span>{Number(data.sentiment_votes_up_percentage
                                            ).toFixed(2)}%</span>
                                                <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <div className='flex justify-between'>
                                            <div className={`text-sm px-1 ml-2 my-1 font-medium flex items-center rounded uppercase bg-opacity-25 bg-red text-red`}><span>{Number(data.sentiment_votes_down_percentage).toFixed(2)}%</span>
                                                <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg"
