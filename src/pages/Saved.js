...
const Saved = () => {
  ...
  return (
    <section className="xs:w-[80%] w-[90%] h-full flex flex-col mt-16 mb-24 relative">
      <div className="flex flex-col min-h-[60vh] border border-gray-100 rounded">
        {savedData ? (
                    ...
                    >
                      ...
                      <td
                        className={
                          ...
                          ? 'text-green py-4 sm:table-cell hidden' : 'text-red py-4 sm:table-cell hidden'
                        }
                      >
                      ...
                      <td
                        className={
                          data.price_change_percentage_1h_in_currency < 0
                            ? 'text-green py-4 lg:table-cell hidden' : 'text-red py-4 lg:table-cell hidden'
                        }
                      >
                        {Number(
